...
class CustomerGroupRepository {
  Future<ApiResponse> getCustomerGroupList({
    ...
    try {
      String query = "/debtaccount/customer-group/list?offset=$offset&limit=$limit&q=$search";
  ...
  Future<ApiResponse> deleteCustomerGroup(String guid) async {
    Dio client = Client().init();
    try {
      final response = await client.delete('/debtaccount/customer-group/$guid');
      try {
  ...
  Future<ApiResponse> deleteCustomerGroupMany(List<String> guids) async {
    Dio client = Client().init();
    try {
      final response = await client.delete('/debtaccount/customer-group', data: guids);
      try {
        return ApiResponse.fromMap(response.data);
      } catch (ex) {
        throw Exception(ex);
  ...
  Future<ApiResponse> getCustomerGroup(String guid) async {
    Dio client = Client().init();
    try {
      final response = await client.get('/debtaccount/customer-group/$guid');
      try {
        return ApiResponse.fromMap(response.data);
      } catch (ex) {
        throw Exception(ex);
  ...
  Future<ApiResponse> saveCustomerGroup(CustomerGroupModel customerGroupModel) async {
    ...
    try {
      final response = await client.post('/debtaccount/customer-group', data: data);
      try {
        return ApiResponse.fromMap(response.data);
      } catch (ex) {
        throw Exception(ex);
  ...
  Future<ApiResponse> updateCustomerGroup(String guid, CustomerGroupModel customerGroupModel) async {
    ...
    final data = customerGroupModel.toJson();
    try {
      final response = await client.put('/debtaccount/customer-group/$guid', data: data);
      try {
        return ApiResponse.fromMap(response.data);
      } catch (ex) {
        throw Exception(ex);
