...
class ProductBarcodeRepository {
  Future<ApiResponse> getProductBarcodeList({
    ...
    // เพิ่มการจัดการ shopsid
    String shopsParam = "";
    if (shopsid.isNotEmpty) {
      shopsParam = "&shopsid=$shopsid";
    }

    try {
      String query = "/product/barcode/list?offset=$offset&limit=$limit&q=$search$itemtype&sort=barcode:1$filtterBom$filtterIsUseSubBarcodes$shopsParam";
  ...
  Future<PriceHistoryResponseModel> getProductBarcodePriceHistory({
