...
class LineNotifyScreen extends StatefulWidget {
  const LineNotifyScreen({super.key});

  @override
  State<LineNotifyScreen> createState() => LineNotifyScreenState();
}

class LineNotifyScreenState extends State<LineNotifyScreen> with SingleTickerProviderStateMixin {
