...
class OrderTypeScreen extends StatefulWidget {
  ...
  @override
  State<OrderTypeScreen> createState() => OrderTypeScreenState();
}

class OrderTypeScreenState extends State<OrderTypeScreen> with SingleTickerProviderStateMixin {
  final translator = GoogleTranslator();
  late TabController tabController;
  ScrollController editScrollController = ScrollController();
  TextEditingController searchController = TextEditingController();
  List<LanguageModel> languageList = <LanguageModel>[];
  List<OrderTypeModel> listData = [];
  ...
  late OrderTypeState blocCurrentState;
  String headerEdit = "";
  ...
  void loadDataList(String search) {
    ...
    searchText = search;
    context.read<OrderTypeBloc>().add(OrderTypeLoadList(offset: (listData.isEmpty) ? 0 : listData.length, limit: global.loadDataPerPage, search: search));
  }
  ...
  void clearEditData() {
    ...
    for (int i = 0; i < screenData.prices!.length; i++) {
      pricenController.add(TextEditingController());
    }
    isDataChange = false;
    setState(() {
      loadDataToScreen();
  ...
  void loadDataToScreen() {
    ...
    for (int i = 0; i < screenData.prices!.length; i++) {
      pricenController[i].text = screenData.prices![i].price.toString();
    }
  }
  ...
  void getData(String guid) {
    ...
    isEditMode = false;
    context.read<OrderTypeBloc>().add(OrderTypeGet(guid: guid));
  }

  void switchToEdit(OrderTypeModel value) {
    setState(() {
  ...
  Widget listScreen({bool mobileScreen = false}) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(global.language("order_type")),
        leading: IconButton(
                      ...
                      builder: (BuildContext context) => AlertDialog(
                        ...
                        actions: <Widget>[
                          ...
                          ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.pop(context);
                                context.read<OrderTypeBloc>().add(OrderTypeDeleteMany(guid: guidListChecked));
                              },
        ...
        child: Column(children: [
          ...
          Container(
              ...
              child: Row(children: [
                Expanded(
                    flex: 5,
                    child: Text(global.language("order_type_code"),
  ...
  Widget listObject(int index, OrderTypeModel value, bool showCheckBox) {
    bool isCheck = false;
  ...
  void saveOrUpdateData() {
    ...
    for (int i = 0; i < screenData.prices!.length; i++) {
      screenData.prices![i].price = double.parse(pricenController[i].text);
    }

    if (selectGuid.trim().isEmpty) {
      context.read<OrderTypeBloc>().add(OrderTypeSave(ordertypemodel: screenData));
    } else {
  ...
  void updateData(String guid) {
    ...
    context.read<OrderTypeBloc>().add(OrderTypeUpdate(guid: guid, ordertypemodel: screenData));
  }
  ...
  Widget editScreen({mobileScreen}) {
      ...
      Padding(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            labelText: global.language("order_type_code"),
          ),
          validator: (value) {
    ...
    for (int languageIndex = 0; languageIndex < languageList.length; languageIndex++) {
      LanguageDataModel ordertypename = screenData.names.firstWhere((element) => element.code == languageList[languageIndex].code, orElse: () => LanguageDataModel(code: '', name: ''));
      if (ordertypename.code == '') {
      ...
      formWidgets.add(Padding(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
              floatingLabelBehavior: FloatingLabelBehavior.always,
              border: const OutlineInputBorder(),
              labelText: "${global.language("order_type_name")} (${getLangName(screenData.names[languageIndex].code)})",
    ...
    for (int i = 0; i < screenData.prices!.length; i++) {
      formWidgets.add(
        Padding(
          padding: const EdgeInsets.only(left: 10, right: 10, bottom: 15),
          child: TextField(
            controller: pricenController[i],
            keyboardType: TextInputType.number,
            inputFormatters: <TextInputFormatter>[FilteringTextInputFormatter.digitsOnly],
            decoration: InputDecoration(
              floatingLabelBehavior: FloatingLabelBehavior.always,
              border: const OutlineInputBorder(),
              labelText: global.language(i == 0 ? "price_adult" : "price_child"),
            ),
            onEditingComplete: () {},
          ),
        ),
    ...
    for (int i = 0; i < screenData.remarks!.length; i++) {
      formWidgets.add(
        Container(
          ...
          child: ElevatedButton.icon(
            focusNode: FocusNode(skipTraversal: true),
            onPressed: () {
              screenData.remarks?.removeAt(i);
              setState(() {});
            },
            icon: const Icon(Icons.delete),
            label: Text(
              "${global.language("remove_remark")} ${i + 1}",
            ),
            style: ButtonStyle(
              backgroundColor: MaterialStateProperty.all<Color>(
                const Color.fromARGB(255, 241, 112, 112),
              ),
      ...
      for (int languageIndex = 0; languageIndex < languageList.length; languageIndex++) {
        LanguageDataModel remark = screenData.remarks![i].firstWhere((element) => element.code == languageList[languageIndex].code, orElse: () => LanguageDataModel(code: '', name: ''));
        if (remark.code == '') {
          screenData.remarks![i].add(LanguageDataModel(code: languageList[languageIndex].code!, name: ''));
        }
        formWidgets.add(Padding(
          padding: const EdgeInsets.only(left: 10, right: 10, bottom: 15),
          child: TextFormField(
            ...
            onChanged: (value) {
              isDataChange = true;
              screenData.remarks![i][languageIndex].name = value;
            },
            textAlign: TextAlign.left,
            controller: TextEditingController(text: screenData.remarks![i][languageIndex].name),
            decoration: InputDecoration(
                floatingLabelBehavior: FloatingLabelBehavior.always,
                border: const OutlineInputBorder(),
                labelText: "${global.language("remark")} (${getLangName(screenData.remarks![i][languageIndex].code)})",
                suffixIcon: isLoadTranslation
                    ? const Padding(
                        padding: EdgeInsets.all(8.0),
                        child: SizedBox(
      ...
      formWidgets.add(
        Container(
          ...
          child: ElevatedButton.icon(
            focusNode: FocusNode(skipTraversal: true),
            onPressed: () {
              screenData.remarks!.add([]);
              setState(() {});
            },
            icon: const Icon(Icons.add),
            label: Text(
              global.language("add_remark"),
            ),
            style: ButtonStyle(
              backgroundColor: MaterialStateProperty.all<Color>(
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            leading: mobileScreen
                ...
                : null,
            title: Text(headerEdit + global.language("order_type")),
            actions: <Widget>[
                          ...
                          builder: (BuildContext context) => AlertDialog(
                            ...
                            actions: <Widget>[
                              ...
                              ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.pop(context);
                                    context.read<OrderTypeBloc>().add(OrderTypeDelete(guid: selectGuid));
                                  },
                    ...
                    child: IconButton(
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          if (screenData.remarks!.isNotEmpty) {
                            /// Translate remarks in global
                            for (int i = 0; i < screenData.remarks!.length; i++) {
                              for (var name in screenData.remarks![i]) {
                                if (name.name.trim().isEmpty) {
                                  var data = await global.translateNames(namesData: screenData.remarks![i]);
                                  setState(() {
                                    screenData.remarks![i] = data;
                                  });
                                  break;
                                }
                              }
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          return MultiBlocListener(
            listeners: [
              BlocListener<OrderTypeBloc, OrderTypeState>(
                listener: (context, state) {
                  ...
                  if (state is OrderTypeLoadSuccess) {
                    setState(() {
                      ...
                      if (state.ordertype.isNotEmpty) {
                        listData.addAll(state.ordertype);
                      }
                    });
                  }
                  if (state is OrderTypeLoadFailed) {
                    setState(() {
                      loadingData = false;
                    });
                  }
                  // Save
                  if (state is OrderTypeSaveSuccess) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  if (state is OrderTypeSaveFailed) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  // Update
                  if (state is OrderTypeUpdateSuccess) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  if (state is OrderTypeUpdateFailed) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  // Delete
                  if (state is OrderTypeDeleteSuccess) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  // Delete Many
                  if (state is OrderTypeDeleteManySuccess) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  // Get
                  if (state is OrderTypeGetSuccess) {
                    setState(() {
                      isDataChange = false;
                      screenData = state.ordertype;
