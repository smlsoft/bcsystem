...
class KitchenScreenState extends State<KitchenScreen> with SingleTickerProviderStateMixin {
  ...
  void loadDataList(String search) {
    ...
    searchText = search;
    context.read<KitchenBloc>().add(KitchenLoadList(offset: (listData.isEmpty) ? 0 : listData.length, limit: global.loadDataPerPage, search: search, groupnumber: widget.groupnumber));
  }
