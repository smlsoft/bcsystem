...
class StaffScreenState extends State<StaffScreen> with SingleTickerProviderStateMixin {
  ...
  void loadDataList(String search) {
    context.read<StaffBloc>().add(StaffLoadList(offset: (listDatas.isEmpty) ? 0 : listDatas.length, limit: global.loadDataPerPage, search: search));
  }
  ...
  void clearEditData() {
    ...
    screenData = StaffModel(guidfixed: "", code: "", email: "", names: [], cashier: false, order: false);
    isChange = false;
    focusNodeIndex = 0;
  }
                      ...
                      builder: (BuildContext context) => AlertDialog(
                        ...
                        actions: <Widget>[
                          ...
                          ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.pop(context);
                                context.read<StaffBloc>().add(StaffDeleteMany(guid: guidListChecked));
                              },
          ...
          child: Column(
            children: [
              ...
              Container(
                  ...
                  child: Row(children: [
                    Expanded(flex: 5, child: Text(global.language("Staff_code"), style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold))),
                    Expanded(
                        flex: 10,
                        child: Text(
  ...
  Widget listObject(StaffModel value, bool showCheckBox) {
    bool isCheck = false;
  ...
  void updateData(String guid) {
    showCheckBox = false;
    context.read<StaffBloc>().add(StaffUpdate(guid: guid, staffModel: screenData));
  }
      ...
      formWidgets.add(Padding(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            floatingLabelBehavior: FloatingLabelBehavior.always,
            border: const OutlineInputBorder(),
            labelText: "${global.language("staff_name")} (${languageList[i].name})",
          ),
        ),
      ));
      nodeIndex++;
                          ...
                          builder: (BuildContext context) => AlertDialog(
                            ...
                            actions: <Widget>[
                              ...
                              ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.pop(context);
                                    context.read<StaffBloc>().add(StaffDelete(guid: selectGuid));
                                  },
