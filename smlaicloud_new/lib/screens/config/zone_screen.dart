...
class ZoneScreen extends StatefulWidget {
  ...
  @override
  State<ZoneScreen> createState() => ZoneScreenState();
}

class ZoneScreenState extends State<ZoneScreen> with SingleTickerProviderStateMixin {
  final translator = GoogleTranslator();
  late TabController tabController;
  ScrollController editScrollController = ScrollController();
  TextEditingController searchController = TextEditingController();
  List<LanguageModel> languageList = <LanguageModel>[];
  List<ZoneDataModel> listData = [];
  ...
  late ZoneState blocCurrentState;
  String headerEdit = "";
  ...
  void loadDataList(String search) {
    ...
    searchText = search;
    context.read<ZoneBloc>().add(ZoneLoadList(offset: (listData.isEmpty) ? 0 : listData.length, limit: global.loadDataPerPage, search: search, groupNumber: widget.groupnumber));
  }
  ...
  void loadDataToScreen() {
    if (screenData.groupnumber == 0) {
      screenData.groupnumber = widget.groupnumber;
    }
  ...
  void getData(String guid) {
    ...
    isEditMode = false;
    context.read<ZoneBloc>().add(ZoneGet(guid: guid));
  }

  void switchToEdit(ZoneDataModel value) {
    setState(() {
  ...
  Widget listScreen({bool mobileScreen = false}) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("${global.language("Zone")} ${widget.groupnumber}"),
        leading: IconButton(
                      ...
                      builder: (BuildContext context) => AlertDialog(
                        ...
                        actions: <Widget>[
                          ...
                          ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.pop(context);
                                context.read<ZoneBloc>().add(ZoneDeleteMany(guid: guidListChecked));
                              },
        ...
        child: Column(children: [
          ...
          Container(
              ...
              child: Row(children: [
                Expanded(
                    flex: 5,
                    child: Text(global.language("Zone_code"),
  ...
  Widget listObject(int index, ZoneDataModel value, bool showCheckBox) {
    bool isCheck = false;
  ...
  void saveOrUpdateData() {
    ...
    if (selectGuid.trim().isEmpty) {
      context.read<ZoneBloc>().add(ZoneSave(zoneDataModel: screenData));
    } else {
  ...
  void updateData(String guid) {
    ...
    context.read<ZoneBloc>().add(ZoneUpdate(guid: guid, zoneDataModel: screenData));
  }
      ...
      Padding(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            floatingLabelBehavior: FloatingLabelBehavior.always,
            border: const OutlineInputBorder(),
            labelText: global.language("Zone_code"),
          ),
          validator: (value) {
            if (value == null || value.isEmpty) {
              return 'This field is required';
      ...
      formWidgets.add(Padding(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            floatingLabelBehavior: FloatingLabelBehavior.always,
            border: const OutlineInputBorder(),
            labelText: "${global.language("Zone_name")} (${getLangName(screenData.names[languageIndex].code)})",
          ),
          validator: (value) {
            if (languageIndex == 0) {
              if (value == null || value.isEmpty) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            leading: mobileScreen
                ...
                : null,
            title: Text("$headerEdit${global.language("Zone")} ${widget.groupnumber}"),
            actions: <Widget>[
                          ...
                          builder: (BuildContext context) => AlertDialog(
                            ...
                            actions: <Widget>[
                              ...
                              ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.pop(context);
                                    context.read<ZoneBloc>().add(ZoneDelete(guid: selectGuid));
                                  },
            ...
            listeners: [
              BlocListener<ZoneBloc, ZoneState>(
                listener: (context, state) {
                  ...
                  if (state is ZoneLoadSuccess) {
                    setState(() {
                      ...
                      if (state.zones.isNotEmpty) {
                        listData.addAll(state.zones);
                      }
                    });
                  }
                  if (state is ZoneLoadFailed) {
                    setState(() {
                      loadingData = false;
                    });
                  }
                  // Save
                  if (state is ZoneSaveSuccess) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  // Delete Many
                  if (state is ZoneDeleteManySuccess) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  // Get
                  if (state is ZoneGetSuccess) {
                    setState(() {
                      isDataChange = false;
                      screenData = state.zone;
