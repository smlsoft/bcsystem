  ...
  void getDataToEditScreen(ProductCategoryModel category) {
    ...
    if (category.timeforsales!.isNotEmpty) {
      ...
      for (int i = 0; i < category.timeforsales!.length; i++) {
        ...
        mediaFromDateController[i].text = (category.timeforsales![i].fromdate!.isNotEmpty) ? DateFormat('dd/MM/yyyy').format(DateTime.parse(category.timeforsales![i].fromdate!)) : '';
