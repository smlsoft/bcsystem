import 'package:smlaicloud/bloc/product_type/product_type_bloc.dart';
...
class ProductTypeScreenState extends State<ProductTypeScreen> with SingleTickerProviderStateMixin {
  ...
  late ProductTypeState blocCurrentState;
  String headerEdit = "";
  ...
  late ProductTypeModel screenData;
  ...
  void loadDataList(String search) {
    ...
    searchText = search;
    context.read<ProductTypeBloc>().add(ProductTypeLoadList(offset: (listData.isEmpty) ? 0 : listData.length, limit: global.loadDataPerPage, search: search));
  }
  ...
  void getData(String guid) {
    ...
    isEditMode = false;
    context.read<ProductTypeBloc>().add(ProductTypeGet(guid: guid));
  }

  void switchToEdit(ProductTypeModel value) {
    setState(() {
                      ...
                      builder: (BuildContext context) => AlertDialog(
                        ...
                        actions: <Widget>[
                          ...
                          ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.pop(context);
                                context.read<ProductTypeBloc>().add(ProductTypeDeleteMany(guid: guidListChecked));
                              },
        ...
        child: Column(children: [
          ...
          Container(
              ...
              child: Row(children: [
                Expanded(
                    flex: 5,
                    child: Text(global.language("product_type_code"),
  ...
  Widget listObject(int index, ProductTypeModel value, bool showCheckBox) {
    bool isCheck = false;
  ...
  void saveOrUpdateData() {
    ...
    if (selectGuid.trim().isEmpty) {
      context.read<ProductTypeBloc>().add(ProductTypeSave(productTypemodel: screenData));
    } else {
  ...
  void updateData(String guid) {
    ...
    context.read<ProductTypeBloc>().add(ProductTypeUpdate(guid: guid, productTypemodel: screenData));
  }
  ...
  Widget editScreen({mobileScreen}) {
      ...
      Padding(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            labelText: global.language("product_type_code"),
          ),
          validator: (value) {
    ...
    for (int languageIndex = 0; languageIndex < languageList.length; languageIndex++) {
      LanguageDataModel productTypename = screenData.names!.firstWhere((element) => element.code == languageList[languageIndex].code, orElse: () => LanguageDataModel(code: '', name: ''));
      if (productTypename.code == '') {
      ...
      formWidgets.add(Padding(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
              floatingLabelBehavior: FloatingLabelBehavior.always,
              border: const OutlineInputBorder(),
              labelText: "${global.language("product_type_name")} (${getLangName(screenData.names![languageIndex].code)})",
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            leading: mobileScreen
                ...
                : null,
            title: Text(headerEdit + global.language("product_type")),
            actions: <Widget>[
                          ...
                          builder: (BuildContext context) => AlertDialog(
                            ...
                            actions: <Widget>[
                              ...
                              ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.pop(context);
                                    context.read<ProductTypeBloc>().add(ProductTypeDelete(guid: selectGuid));
                                  },
            ...
            listeners: [
              BlocListener<ProductTypeBloc, ProductTypeState>(
                listener: (context, state) {
                  ...
                  if (state is ProductTypeLoadSuccess) {
                    setState(() {
                      ...
                      if (state.productType.isNotEmpty) {
                        listData.addAll(state.productType);
                      }
                    });
                  }
                  if (state is ProductTypeLoadFailed) {
                    setState(() {
                      loadingData = false;
                    });
                  }
                  // Save
                  if (state is ProductTypeSaveSuccess) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  if (state is ProductTypeSaveFailed) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  // Update
                  if (state is ProductTypeUpdateSuccess) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  if (state is ProductTypeUpdateFailed) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  // Delete
                  if (state is ProductTypeDeleteSuccess) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  // Delete Many
                  if (state is ProductTypeDeleteManySuccess) {
                    setState(() {
                      global.showSnackBar(
                          context,
                          const Icon(
                  ...
                  // Get
                  if (state is ProductTypeGetSuccess) {
                    setState(() {
                      isDataChange = false;
                      screenData = state.productType;
