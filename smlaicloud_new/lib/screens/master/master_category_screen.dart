...
class MasterCategoryScreen extends StatefulWidget {
  ...
  @override
  State<MasterCategoryScreen> createState() => MasterCategoryScreenState();
}

class MasterCategoryScreenState extends State<MasterCategoryScreen>
  ...
  List<String> categoryGuidListChecked = [];
  ...
  late MasterCategoryState blocMasterCategoryState;
  String headerEdit = "";
  ...
  void getData(String guid) {
    ...
    context.read<MasterCategoryBloc>().add(MasterCategoryGet(guid: guid));
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          if (categoryGuidListChecked.isNotEmpty)
            Padding(
                padding: const EdgeInsets.only(right: 20.0),
                child: IconButton(
                  focusNode: FocusNode(skipTraversal: true),
                          ...
                          ElevatedButton(
                              ...
                              onPressed: () {
                                ...
                                context.read<MasterCategoryBloc>().add(
                                    MasterCategoryDeleteMany(
                                        guid: categoryGuidListChecked));
                              },
        ...
        children: [
          ...
          Container(
              ...
              child: Row(children: [
                Expanded(
                    flex: 5,
                    child: Text(global.language("category_code"),
                        style: TextStyle(
  ...
  void switchToEdit(MasterCategoryModel value) {
    setState(() {
  ...
  Widget listObject(int index, MasterCategoryModel value, bool showCheckBox) {
    bool isCheck = false;
    for (int i = 0; i < categoryGuidListChecked.length; i++) {
      if (categoryGuidListChecked[i] == value.guidfixed) {
        isCheck = true;
        break;
      }
    }
        ...
        onTap: () {
          if (showCheckBox == true) {
            setState(() {
              selectGuid = value.guidfixed;
              if (isCheck == true) {
                categoryGuidListChecked.remove(value.guidfixed);
              } else {
                categoryGuidListChecked.add(value.guidfixed);
              }
              global.showSnackBar(
                  context,
                  const Icon(
                  ...
                  "${global.language("chosen")} ${categoryGuidListChecked.length} ${global.language("list")}",
                  Colors.blue);
            });
          } else {
            setState(() {
  ...
  bool verifyData(MasterCategoryModel value) {
  ...
  void saveOrUpdateData() {
    if (screenEvent == global.ScreenEventEnum.edit ||
      ...
      MasterCategoryModel category = MasterCategoryModel(
        guidfixed: "",
      ...
      if (verifyData(category)) {
        ...
        if (selectGuid.trim().isEmpty) {
          context
              .read<MasterCategoryBloc>()
              .add(MasterCategorySave(categoryModel: category));
        } else {
          context.read<MasterCategoryBloc>().add(
              MasterCategoryUpdate(guid: selectGuid, categoryModel: category));
        }
      }
    }
  }

  void getDataToEditScreen(MasterCategoryModel category) {
    isChange = false;
    selectGuid = category.guidfixed;
    fieldTextController[0].text = category.code;
    for (int i = 0; i < languageList.length; i++) {
    ...
    for (int i = 0; i < languageList.length; i++) {
      for (int j = 0; j < category.names.length; j++) {
        if (languageList[i].code! == category.names[j].code) {
          fieldTextController[i + 1].text = category.names[j].name;
        }
      }
    }
  }
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            leading: mobileScreen
                ...
                : null,
            title: Text(headerEdit + global.language("category")),
            actions: <Widget>[
                            ...
                            actions: <Widget>[
                              ...
                              ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.pop(context);
                                    context.read<MasterCategoryBloc>().add(
                                        MasterCategoryDelete(guid: selectGuid));
                                  },
                                  child: Text(global.language('confirm'))),
                            ],
                          ),
                    ...
                    child: Column(children: [
                      ...
                      TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            labelText: global.language("category_code"),
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              border: const OutlineInputBorder(),
                              labelText:
                                  "${global.language("category_name")} (${languageList[i].name})",
        ...
        body: LayoutBuilder(builder: (context, constraints) {
          return BlocListener<MasterCategoryBloc, MasterCategoryState>(
              listener: (context, state) {
                blocMasterCategoryState = state;
                if (state is MasterCategoryLoadSuccess) {
                  setState(() {
                    if (state.categories.isNotEmpty) {
                      listData.addAll(state.categories);
                    }
                  });
                }
                if (state is MasterCategorySaveSuccess) {
                  setState(() {
                    global.showSnackBar(
                        context,
                        const Icon(
                ...
                if (state is MasterCategorySaveFailed) {
                  setState(() {
                    global.showSnackBar(
                        context,
                        const Icon(
                ...
                if (state is MasterCategoryUpdateSuccess) {
                  setState(() {
                    global.showSnackBar(
                        context,
                        const Icon(
                ...
                if (state is MasterCategoryUpdateFailed) {
                  setState(() {
                    global.showSnackBar(
                        context,
                        const Icon(
                ...
                if (state is MasterCategoryDeleteSuccess) {
                  setState(() {
                    global.showSnackBar(
                        context,
                        const Icon(
                ...
                if (state is MasterCategoryDeleteManySuccess) {
                  setState(() {
                    global.showSnackBar(
                        context,
                        const Icon(
                ...
                if (state is MasterCategoryGetSuccess) {
                  setState(() {
