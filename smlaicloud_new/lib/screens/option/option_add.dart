...
class _OptionAddState extends State<OptionAdd> {
  ...
  void initState() {
    ...
    if (!createMode) {
      context.read<OptionBloc>().add(ListOptionLoadById(id: widget.guidfixed.toString()));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<OptionBloc, OptionState>(
      ...
      child: Scaffold(
        appBar: BaseAppBar(
          title: (createMode) ? const Text("เพิ่มตัวเลือกเสริม") : const Text("แก้ไขตัวเลือกเสริม"),
          leading: IconButton(
            color: Colors.black,
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                              ...
                              var _result = await Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => OptionDetailScreen(
                                    choices: ChoiceModel(isdefault: true, selected: false),
                                  ),
                                ),
                              );
                          ...
                          itemBuilder: (context, index) {
                            return Card(
                              child: ListTile(
                                ...
                                subtitle: Column(
                                  children: [
                                    Text("ชื่อ 1 :  ${_optionChoices[index].name1} "),
                                    ...
                                    Text("ราคา : + ${_optionChoices[index].price} บาท"),
                                ...
                                onTap: () async {
                                  var _result = await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => OptionDetailScreen(choices: _optionChoices[index]),
                                    ),
                                  );
                        ...
                        const TitleLabel(
                          ...
                          subtitle: "เช่น ต้องเลือกอย่างน้อย 1 อย่าง, ไม่บังคับ",
                        ),
                        SizedBox(height: size.height * 0.03),
                        Align(
                          alignment: Alignment.centerLeft,
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            OptionModel _option = OptionModel(
