...
class FormDesignHeaderModel {
  ...
  factory FormDesignHeaderModel.fromJson(Map<String, dynamic> json) => _$FormDesignHeaderModelFromJson(json);
...
class FormDesignFooterModel {
  ...
  factory FormDesignFooterModel.fromJson(Map<String, dynamic> json) => _$FormDesignFooterModelFromJson(json);
