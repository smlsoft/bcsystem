...
Future<Uint8List> generateStockTransfer(
  ...
  screenData.details!.removeWhere((element) => element.calcflag == 1);
...
pw.Widget _contentTable(pw.Context context, TransactionModel screenData) {
  const tableHeaders = ['ลำดับที่', 'บาร์โค้ด', 'รายการสินค้า', 'คลัง/ออก', 'ที่เก็บ/ออก', 'คลััง/เข้า', 'ที่เก็บ/เข้า', 'หน่วย', 'จำนวน'];
...
String _cellValue(int rowIndex, int columnIndex, TransactionModel screenData) {
  if (screenData.details![rowIndex].calcflag == -1) {
    switch (columnIndex) {
      case 0:
        return '${rowIndex + 1}';
      case 1:
      ...
      case 5:
        return global.activeLangName(screenData.details![rowIndex].towhnames!);
      case 6:
        return global.activeLangName(screenData.details![rowIndex].tolocationnames!);
      case 7:
