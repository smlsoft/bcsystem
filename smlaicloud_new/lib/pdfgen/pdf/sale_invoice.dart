...
class Invoice {
    ...
    doc.addPage(
      pw.MultiPage(
        ...
        header: (context) => pw.Padding(
          ...
          child: _buildHeader(context, logoBytes, screenData),
        ),
        build: (context) => [
          pw.Padding(
        ...
        children: [
          ...
          pw.Expanded(
            child: pw.Column(
              ...
              children: [
                ...
                pw.SizedBox(height: 30), // พื้นที่สำหรับลายเซ็น
                pw.Container(
                  height: 1,
                  color: PdfColors.black,
          ...
          pw.Expanded(
            child: pw.Column(
              ...
              children: [
                pw.Text(
                  'ในนาม ${global.activeLangName(companyBranchData.companynames)}',
                  style: pw.TextStyle(
                    fontSize: 12,
                    fontWeight: pw.FontWeight.bold,
                    color: PdfColors.black,
  ...
  pw.Widget _buildHeader(pw.Context context, Uint8List? logoBytes, TransactionModel screenData) {
    return pw.Column(
      children: [
        ...
        pw.Padding(
          ...
          child: pw.Text(
            (F.appFlavor == Flavor.dohomedev || F.appFlavor == Flavor.dohomeprod || F.appFlavor == Flavor.dohomeuat)
                ? global.language((screenData.inquirytype == 0) ? 'delivery_note' : 'text_form_receipt/tax_invoice')
                : global.language('text_form_receipt/tax_invoice'),
            style: pw.TextStyle(
              fontSize: 20,
              fontWeight: pw.FontWeight.bold,
            ),
  ...
  pw.Widget _buildCompanyDetails(Uint8List? logoBytes) {
    return pw.Container(
      child: pw.Row(
        crossAxisAlignment: pw.CrossAxisAlignment.center,
        children: [
          if (logoBytes != null) pw.Image(pw.MemoryImage(logoBytes), width: 80, height: 50) else pw.Container(),
          if (logoBytes != null) pw.SizedBox(width: 10) else pw.Container(),
  ...
  pw.Widget _buildCustomerDetails() {
    return _buildDetailBox(
      width: 337,
      children: [
        _detailRowCust('ผู้ซื้อ', "${screenData.custcode} ~ ${global.activeLangName(screenData.custnames!)}"),
        _detailRowCust(
          'ที่อยู่',
  ...
  pw.Widget _buildDocumentDetails() {
    return _buildDetailBox(
      ...
      children: [
        ...
        _detailRow('เลขที่ใบกำกับ', screenData.taxdocno),
        _detailRow(
          'วันที่ใบกำกับ',
            ...
            child: pw.DefaultTextStyle(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  //   children: [
                  //     pw.Expanded(
                  //       child: pw.Text('หัก ส่วนลดก่อนภาษี'),
                  //     ),
                  //     pw.Expanded(
                  //       child: pw.Text(
...
pw.Widget _contentTable(pw.Context context, TransactionModel screenData) {
  const tableHeaders = ['ลำดับที่', 'บาร์โค้ด', 'รายการสินค้า', 'จำนวน', 'หน่วย', 'ราคา', 'จำนวนเงิน'];
