...
class ProductLabelPrintShelf {
  ...
  static Future<void> showPdfPreview(BuildContext context, List<ProductBarcodeModel> products, List<int> copies, {bool showImages = true}) async {
  ...
  static Future<Map<String, bool>?> _showPrintSettingsDialog(BuildContext context) async {
    bool showImages = false; // แสดงรูปภาพ
  ...
  static pw.Widget _buildProductCell(
    ...
    return pw.Container(
      ...
      child: pw.Column(
        children: [
          // รูปภาพ หรือพื้นที่สำหรับรูปภาพ
          pw.Expanded(
            flex: 6,
            child: pw.Container(
