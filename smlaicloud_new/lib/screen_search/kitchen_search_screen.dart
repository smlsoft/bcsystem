...
class KitchenSearchScreenState extends State<KitchenSearchScreen> with SingleTickerProviderStateMixin {
  ...
  void loadDataList(String search) {
    context.read<KitchenBloc>().add(KitchenLoadList(offset: (kitchenListData.isEmpty) ? 0 : kitchenListData.length, limit: global.loadDataPerPage, search: search, groupnumber: widget.groupnumber));
  }
