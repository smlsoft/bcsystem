...
class ProductTypeSearchScreenState extends State<ProductTypeSearchScreen> with SingleTickerProviderStateMixin {
  ...
  void loadDataList(String search) {
    context.read<ProductTypeBloc>().add(ProductTypeLoadList(offset: (productTypetListData.isEmpty) ? 0 : productTypetListData.length, limit: global.loadDataPerPage, search: search));
  }
