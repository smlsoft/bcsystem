...
class TransportSearchScreen extends StatefulWidget {
  const TransportSearchScreen({super.key, required this.word});
  final String word;

  @override
  State<TransportSearchScreen> createState() => TransportSearchScreenState();
}

class TransportSearchScreenState extends State<TransportSearchScreen> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pop(context, TransportChannelModel(code: "", name: "", guidfixed: ''));
          },
        ),
      ),
      body: Focus(
            ...
            if (kIsWeb || Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
              if (event is RawKeyDownEvent) {
                ...
                if (event.logicalKey == LogicalKeyboardKey.tab) {
                  if (selectGuid != "") {
                    Navigator.pop(context, TransportChannelModel(code: listData[currentListIndex].code, name: listData[currentListIndex].name, guidfixed: listData[currentListIndex].guidfixed));
                  }
                }
  ...
  Widget listObject(TransportChannelModel value) {
    return GestureDetector(
        onTap: () {
          Navigator.pop(context, TransportChannelModel(code: value.code, name: value.name, guidfixed: value.guidfixed));
        },
        child: Container(
            decoration: BoxDecoration(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: LayoutBuilder(builder: (context, constraints) {
          return BlocListener<TransportChannelBloc, TransportChannelState>(
