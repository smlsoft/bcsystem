...
class NumberPad extends StatefulWidget {
  ...
  const NumberPad({Key? key, required this.onChange, this.title, this.unitName, this.textAlign = TextAlign.right, this.backgroundColor = Colors.white, this.header = ""}) : super(key: key);
