...
PosProcessDetailModel _$PosProcessDetailModelFromJson(
    ...
    PosProcessDetailModel(
      ...
      unit_dividend: (json['unit_dividend'] as num?)?.toDouble() ?? 0,
      unit_divisor: (json['unit_divisor'] as num?)?.toDouble() ?? 0,
    );
...
PosProcessModel _$PosProcessModelFromJson(Map<String, dynamic> json) =>
    PosProcessModel(
      ...
      total_alcohol_amount:
          (json['total_alcohol_amount'] as num?)?.toDouble() ?? 0,
      total_other_amount: (json['total_other_amount'] as num?)?.toDouble() ?? 0,
      total_food_amount: (json['total_food_amount'] as num?)?.toDouble() ?? 0,
      total_cheque_amount:
          (json['total_cheque_amount'] as num?)?.toDouble() ?? 0,
      total_transfer_amount:
          (json['total_transfer_amount'] as num?)?.toDouble() ?? 0,
      total_coupon_amount:
          (json['total_coupon_amount'] as num?)?.toDouble() ?? 0,
      total_credit_amount:
          (json['total_credit_amount'] as num?)?.toDouble() ?? 0,
      total_credit_card_amount:
          (json['total_credit_card_amount'] as num?)?.toDouble() ?? 0,
      total_qr_code_amount:
          (json['total_qr_code_amount'] as num?)?.toDouble() ?? 0,
