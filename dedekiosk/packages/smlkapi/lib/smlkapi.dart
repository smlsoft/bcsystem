...
class SMLKBankConnector {
  ...
  Future<QRGenerateResponse> CreateQRCreditCardTransaction(Decimal amount, String ref1, ref2, ref3, ref4) async {
    ...
    try {
      ...
      if (ex.response != null) {
        QRGenerateResponse qrPaymentResponseToJson = new QRGenerateResponse(
          txnUid: "",
          partnerId: "",
          statusCode: "",
          errorCode: "ERROR",
  ...
  Future<QRPaymentStatusResponse> CheckPayment(String txnId) async {
    ...
    try {
      ...
      if (ex.response != null) {
        QRPaymentStatusResponse qrPaymentResponseToJson = new QRPaymentStatusResponse(
          txnUid: "",
          txnNo: "",
          txnStatus: "ERROR",
          txnAmount: 0,
  ...
  Future<QRTransactionInquiryResponse> InquiryPayment(String txnId) async {
    ...
    try {
      ...
      if (ex.response != null) {
        ...
        QRTransactionInquiryResponse qrPaymentResponseToJson = new QRTransactionInquiryResponse(
          partnerTxnUid: "",
          partnerId: "",
          statusCode: "ERROR",
          errorCode: "ERROR",
  ...
  Future<QRTransactionCommonResponse> CancelPayment(String txnId) async {
    ...
    try {
      ...
      if (ex.response != null) {
        ...
        QRTransactionCommonResponse qrPaymentResponseToJson = new QRTransactionCommonResponse(
          partnerTxnUid: "",
          partnerId: "",
          statusCode: "ERROR",
          errorCode: "ERROR",
