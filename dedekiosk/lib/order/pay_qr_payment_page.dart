...
class PayQRPaymentPage extends StatefulWidget {
  final double amount;

  const PayQRPaymentPage({super.key, required this.amount});

  @override
  PayQRPaymentPageState createState() => PayQRPaymentPageState();
}

enum EDCStatus { Waiting, Success, Cancel, DuplicateSend, Error, Noting }

class PayQRPaymentPageState extends State<PayQRPaymentPage> {
  ...
  Future<void> sendDataToDevice() async {
    ...
    try {
      ...
      List<int> datas = message.createSaleQRPaymentMessage(
