...
class EdcMessage {
  ...
  List<int> createSaleQRCreditMessage(double amount, String ref1, String ref2) {
    List<int> saleMessageBody = _buildSaleQRCreditMessageData(amount, ref1, ref2);
    List<int> messageBytes = _buildMessageStruct(saleMessageBody);

    return messageBytes;
  }

  List<int> createSaleQRPaymentMessage(double amount, String ref1, String ref2) {
    List<int> saleMessageBody = _buildSaleQRPaymentMessageData(amount, ref1, ref2);
    List<int> messageBytes = _buildMessageStruct(saleMessageBody);
  ...
  List<int> _buildSaleQRCreditMessageData(double amount, String ref1, String ref2) {
    List<int> __dataByte = [];
    ...
    List<int> presentationHeaderBytes = _getBytesValue(presentationHeader);
    List<int> fieldAmountBytes = _buildSaleAmountFieldElement(amount);
    List<int> fieldWalletPaymentThaiQRPayment = _buildSaleQRCreditPaymentFieldElement();
    ...
    __dataByte.add(FIELD_SEPARATOR);
    __dataByte.addAll(fieldAmountBytes);
    __dataByte.addAll(fieldWalletPaymentThaiQRPayment);
  ...
  List<int> _buildSaleQRPaymentMessageData(double amount, String ref1, String ref2) {
    List<int> __dataByte = [];
  ...
  List<int> _buildSaleQRCreditPaymentFieldElement() {
    List<int> fieldTypeRef2Bytes = _getBytesValue(FIELD_TYPE_WALLET_COMMAND_TYPE);
    List<int> fieldRef2Byte = _getBytesValue(FIELD_TYPE_WALLET_COMMAND_TYPE_CREDIT_QR_APPLICATION);
    List<int> LLLL = calcBCDLength(2);

    List<int> __dataByte = [];
    __dataByte.addAll(fieldTypeRef2Bytes);
    __dataByte.addAll(LLLL);
    __dataByte.addAll(fieldRef2Byte);
    __dataByte.add(FIELD_SEPARATOR);
