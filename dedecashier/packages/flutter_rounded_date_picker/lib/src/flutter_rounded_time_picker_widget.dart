...
class _DialState extends State<_Dial> with SingleTickerProviderStateMixin {
  ...
  List<_TappableLabel> _buildMinutes(TextTheme textTheme) {
    ...
    return <_TappableLabel>[
      for (TimeOfDay timeOfDay in minuteMarkerValues)
        _buildTappableLabel(
          textTheme,
          timeOfDay.minute,
...
Future<TimeOfDay?> showRoundedTimePicker({
  ...
  final Widget dialog = _TimePickerDialog(
    ...
    style: MaterialRoundedDatePickerStyle(
      ...
      textStyleButtonPositive: TextStyle(color: Colors.black),
      textStyleButtonNegative: TextStyle(color: Colors.black),
      textStyleButtonAction: TextStyle(color: Colors.black),
