...
import 'package:gbprimepay/models/models.dart';

void main() {
  const String testPublicKey = String.fromEnvironment("GBPRIMEPAY_PUBLIC_KEY");
  const String testSecretKey = String.fromEnvironment("GBPRIMEPAY_SECRET_KEY");
  const String testToken = String.fromEnvironment("GBPRIMEPAY_ACCESS_TOKEN");
