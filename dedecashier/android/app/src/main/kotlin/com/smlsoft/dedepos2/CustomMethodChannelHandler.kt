...
class CustomMethodChannelHandler(private val context: Context, private val messenger: BinaryMessenger) {
    private val CHANNEL = "com.smlsoft.dedecashier/usb"
    ...
    fun setupChannel() {
        ...
        EventChannel(messenger, "com.smlsoft.dedecashier/stream").setStreamHandler(
