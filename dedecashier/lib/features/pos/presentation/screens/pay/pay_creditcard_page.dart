...
class PayCreditCardPage extends StatefulWidget {
  ...
  const PayCreditCardPage({super.key, required this.amount});
...
class PayCreditCardPageState extends State<PayCreditCardPage> {
  ...
  Future<void> sendDataToDevice() async {
    ...
    try {
      ...
      List<int> datas = message.createSaleCreditCardMessage(
      ...
      if (edcResponse.isResponseSuccess()) {
        ...
        setState(() {
          global
              ...
              .add(
                PayCreditCardModel(
                  book_bank_code: edcResponse.cardIssuerName ?? "",
                  bank_code: edcResponse.cardIssuerName ?? "",
                  bank_name: edcResponse.cardHolderName ?? "",
                  card_number: edcResponse.cardNumber ?? "",
                  approved_code: edcResponse.approvalCode ?? "",
