...
import 'package:dedecashier/features/pos/presentation/screens/pos_bill_vat_detail.dart';
...
class PosBillVatScreen extends StatefulWidget {
  ...
  @override
  const PosBillVatScreen({super.key, required this.posScreenMode});
    ...
    return BlocBuilder<BillBloc, BillState>(
      builder: (context, state) {
        ...
        if (state is BillLoading) {
          return Scaffold(
            appBar: AppBar(
              title: Text(global.language("pos_bill_vat"), style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 20)),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            isSearching ? 'ไม่พบบิลที่ค้นหา' : 'ไม่มีบิล VAT',
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: Colors.grey[600]),
          ),
          const SizedBox(height: 8),
          Text(isSearching ? 'ลองค้นหาด้วยคำอื่น' : 'บิล VAT จะแสดงที่นี่', style: TextStyle(fontSize: 14, color: Colors.grey[500])),
        ],
      ),
    );
  }
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: "ค้นหาบิล VAT (เลขที่บิล หรือ วันที่)",
        ...
        builder: (context, constraints) {
          ...
          return GridView.builder(
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              crossAxisSpacing: 8, // ลดจาก 12 เป็น 8
              mainAxisSpacing: 8, // ลดจาก 12 เป็น 8
            ),
        ...
        child: InkWell(
          ...
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => PosBillVatDetailScreen(posScreenMode: widget.posScreenMode, docNumber: bill.doc_number),
              ),
            );
          },
          child: Container(
