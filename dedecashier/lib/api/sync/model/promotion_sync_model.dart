...
part 'promotion_sync_model.g.dart';

@JsonSerializable()
class PromotionSyncModel {
  ...
  String discounttext;
  // รายการ Promotion
  List<PromotionBarcodeSyncIncludeModel> promotionbarcodeinclude;
  // จำนวนที่ต้องซื้อ
  double limitqty;
  // จำนวนที่แถม
  double promotionqty;
  ...
  PromotionSyncModel(
      ...
      : guidfixed = guidfixed ?? "",
        ...
        promotionbarcodeinclude = promotionbarcodeinclude ?? [PromotionBarcodeSyncIncludeModel(promotionproduct: [], includeproduct: [])];

  factory PromotionSyncModel.fromJson(Map<String, dynamic> json) => _$PromotionSyncModelFromJson(json);
  Map<String, dynamic> toJson() => _$PromotionSyncModelToJson(this);
}

@JsonSerializable()
class PromotionSyncBarcodeModel {
  String barcode;
  List<LanguageDataModel> name;
  String unitcode;
  ...
  PromotionSyncBarcodeModel({String? barcode, List<LanguageDataModel>? name, String? unitcode, List<LanguageDataModel>? unitname, double? qty, double? price, String? discountText})
      : barcode = barcode ?? "",
        name = name ?? [],
        unitcode = unitcode ?? "",
        discounttext = discountText ?? "",
  ...
  factory PromotionSyncBarcodeModel.fromJson(Map<String, dynamic> json) => _$PromotionSyncBarcodeModelFromJson(json);
  Map<String, dynamic> toJson() => _$PromotionSyncBarcodeModelToJson(this);
}

@JsonSerializable()
class PromotionBarcodeSyncIncludeModel {
  // ซื้อ xxx แถม xxx ชิ้น
  final List<PromotionSyncBarcodeModel> promotionproduct; // เงื่อนไข
  final List<PromotionSyncBarcodeModel> includeproduct; // รายการที่แถม

  PromotionBarcodeSyncIncludeModel({List<PromotionSyncBarcodeModel>? promotionproduct, List<PromotionSyncBarcodeModel>? includeproduct})
      : promotionproduct = promotionproduct ?? [],
        includeproduct = includeproduct ?? [];

  factory PromotionBarcodeSyncIncludeModel.fromJson(Map<String, dynamic> json) => _$PromotionBarcodeSyncIncludeModelFromJson(json);
  Map<String, dynamic> toJson() => _$PromotionBarcodeSyncIncludeModelToJson(this);
}
