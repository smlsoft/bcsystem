  ...
  Widget build(BuildContext context) {
    Widget label = icon != null
        ? FittedBox(
            ...
            child: Icon(
              icon,
              shadows: const <Shadow>[Shadow(blurRadius: 1.0, color: Colors.black, offset: Offset(2.0, 2.0))],
        ...
        : Text(
            ...
            style: TextStyle(
              ...
              shadows: const [Shadow(blurRadius: 1.0, color: Colors.black, offset: Offset(2.0, 2.0))],
              color: ((textAndIconColor == null) ? Colors.white : textAndIconColor),
            ),
          );
    ElevatedButton button = ElevatedButton(
      style: ElevatedButton.styleFrom(backgroundColor: color ?? _themeColor, minimumSize: Size.zero),
      onPressed: () {
    ...
    return (margin == 0) ? button : Padding(padding: EdgeInsets.all(margin), child: button);
  }
}
...
class CommandButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget labelAndStyle = Text(label, style: buttonStyle, textAlign: TextAlign.center, overflow: TextOverflow.clip);
