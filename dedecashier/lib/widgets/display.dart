Display displayFromJson(Map<String, dynamic> json) => Display(displayId: json['displayId'], flag: json['flags'], name: json['name'], rotation: json['rotation']);

/// for release please check response from invokeMethod
Display displayReleaseFromJson(Map<String, dynamic> json) => Display(displayId: json['a'], flag: json['b'], name: json['d'], rotation: json['c']);
