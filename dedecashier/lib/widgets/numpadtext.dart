...
class NumberPadText extends StatefulWidget {
  ...
  const NumberPadText({super.key, required this.onChange, this.title, this.unitName, this.textAlign = TextAlign.left, this.backgroundColor = Colors.white, this.header = ""});
