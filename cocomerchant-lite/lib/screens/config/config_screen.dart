...
class ConfigScreenState extends State<ConfigScreen> with SingleTickerProviderStateMixin {
  ...
  void loadDataList() {
    context.read<ShopBloc>().add(GetShopInfo(shopid: appConfig.read("shopid")));
  }
          ...
          if (state is GetShopInfoSuccess) {
            setState(() {
              if (state.shop.guidfixed!.isNotEmpty) {
                ...
                vatrateController.text = screenData.settings!.vatrate.toString();
              }
              // global.showSnackBar(
              //   context,
              //   const Icon(
                ...
                child: Center(
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        children: [
                          const Text('เลือกภาษาข้อมูล', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                                    ...
                                    Expanded(
                                      child: ElevatedButton(
                                          onPressed: () {
                                            ...
                                            for (var selected in screenData.settings!.languageconfigs!) {
                                            ...
                                            showDialog(
                                                      ...
                                                      child: ListView.builder(
                                                        ...
                                                        itemBuilder: (context, index) {
                                                          return ListTile(
                                                            ...
                                                            onTap: () {
                                                              setState(() {
                                                                Navigator.of(context).pop(languagesSelectList[index].code);
                                                              });
                                                            },
                                                          );
                                                        },
                                              ...
                                              setState(() {
                                                if (value != null) {
                                                  screenData.settings!.languageconfigs![i].code = value.toString();
                                                  screenData.settings!.languageconfigs![i].codeTranslator = value.toString();

                                                  screenData.settings!.languageconfigs![i].name =
                                                      defaultlanguageList.firstWhere((element) => element.code == value.toString()).name;
                                                  screenData.settings!.languageconfigs![i].isuse = true;
                                                }
                                              });
                                            });
                                          },
                                          child: Row(children: [
                                            (screenData.settings!.languageconfigs![i].code!.isNotEmpty)
                                                ? Image.asset(
                                            ...
                                            (screenData.settings!.languageconfigs![i].code!.isNotEmpty)
                                                ? Text(defaultlanguageList.firstWhere((element) => element.code == screenData.settings!.languageconfigs![i].code).name!)
                                ...
                                (i == 0)
                                    ...
                                    : SizedBox(
                                        ...
                                        child: IconButton(
                                            onPressed: () {
                                              setState(() {
                                                screenData.settings!.languageconfigs!.removeAt(i);
                                              });
                                            },
                                            color: Colors.red,
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                setState(() {
                                  screenData.settings!.languageconfigs!.add(LanguageModel(code: "", codeTranslator: "", name: "", isuse: false));
                                });
                              },
                              child: Text(
                    ...
                    //     children: [
                    //       /// อัตราภาษี
                    //       Text(global.language("vat_rate"), style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                    //       const SizedBox(height: 10),
                    ...
                    //           if (value.isNotEmpty) {
                    //             if (value == '0') {
                    //               vatrateController.selection = TextSelection.fromPosition(TextPosition(offset: vatrateController.text.length));
                    //               screenData.settings!.vatrate = double.parse(vatrateController.text);
                    //             } else {
                    //               screenData.settings!.vatrate = double.parse(vatrateController.text);
                    //             }
                    //           } else {
                    //             TextEditingController(text: screenData.settings!.vatrate.toString()).text = '0';
                    //             screenData.settings!.vatrate = double.parse(vatrateController.text);
                    //           }
                    //         },
                    //       ),
                    ...
                    //       /// ประเภทภาษีซื้อ
                    //       Text(global.language("vattype_purchase"), style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                    //       const SizedBox(height: 10),
                    //       Row(
                    ...
                    //               Radio(
                    //                   value: 0,
                    //                   groupValue: screenData.settings!.vattypepurchase,
                    //                   onChanged: (value) {
                    //                     setState(() {
                    //                       screenData.settings!.vattypepurchase = value;
                    //                     });
                    //                   }),
                    //               Expanded(
                    //                   child: Text(
                    ...
                    //       /// ประเภทรายการซื้อ
                    //       Text(global.language("inquirytype_purchase"), style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                    //       const SizedBox(height: 10),
                    //       Row(
                    //         mainAxisAlignment: MainAxisAlignment.start,
                    //         children: [
                    ...
                    //               Radio(
                    //                   value: 0,
                    //                   groupValue: screenData.settings!.inquirytypepurchase,
                    //                   onChanged: (value) {
                    //                     setState(() {
                    //                       screenData.settings!.inquirytypepurchase = value;
                    //                     });
                    //                   }),
                    //               Expanded(
                    //                   child: Text(
                    ...
                    //           /// ประเภทภาษีขาย
                    //           Text(global.language("vattype_sale"), style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                    //           const SizedBox(height: 10),
                    //           Row(
                    //             mainAxisAlignment: MainAxisAlignment.start,
                    //             children: [
                    ...
                    //                   Radio(
                    //                       value: 0,
                    //                       groupValue: screenData.settings!.vattypesale,
                    //                       onChanged: (value) {
                    //                         setState(() {
                    //                           screenData.settings!.vattypesale = value;
                    //                         });
                    //                       }),
                    //                   Expanded(
                    //                       child: Text(
                    ...
                    //           /// ประเภทการขาย
                    //           Text(global.language("inquirytype_sale"), style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                    //           const SizedBox(height: 10),
                    //           Row(
                    //             mainAxisAlignment: MainAxisAlignment.start,
                    //             children: [
                    ...
                    //                   Radio(
                    //                       value: 0,
                    //                       groupValue: screenData.settings!.inquirytypesale,
                    //                       onChanged: (value) {
                    //                         setState(() {
                    //                           screenData.settings!.inquirytypesale = value;
                    //                         });
                    //                       }),
                    //                   Expanded(
                    //                       child: Text(
