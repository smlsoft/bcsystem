...
import 'package:cocomerchant_lite/bloc/qr/qr_bloc.dart';
    ...
    return GestureDetector(
        ...
        child: Container(
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(
                  flex: 10,
                  child: Text(global.packName(value.qrnames!), maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: global.deviceConfig.listDataFontSize))),
                      ...
                      Expanded(
                        child: Row(
                          children: [
                            ...
                            Text(global.language("promptpay")),
                          ],
                        ),
                      ),
                      Expanded(
                        child: Row(
                          children: [
                            ...
                            Text(global.language("lugent_promptpay")),
                          ],
                        ),
                      ),
                    ],
                      ...
                      Expanded(
                        child: Row(
                          children: [
                            ...
                            Text(global.language("lugent_alipay")),
                          ],
                        ),
                      ),
                      Expanded(
                        child: Row(
                          children: [
                            ...
                            Text(global.language("lugent_true_money")),
                          ],
                        ),
                      ),
                    ],
                      ...
                      Expanded(
                        child: Row(
                          children: [
                            ...
                            Text(global.language("lugent_line_pay")),
                          ],
                        ),
                      ),
                    ],
