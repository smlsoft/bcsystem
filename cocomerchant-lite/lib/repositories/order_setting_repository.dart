...
class OrderSettingRepository {
  Future<ApiResponse> getOrderList({
    ...
    try {
      String query = "/order/device/list?offset=$offset&limit=$limit&q=$search";
  ...
  Future<ApiResponse> deleteOrder(String guid) async {
    Dio client = Client().init();
    try {
      final response = await client.delete('/order/device/$guid');
      try {
  ...
  Future<ApiResponse> deleteOrderMany(List<String> guids) async {
    ...
    try {
      ...
      final response = await client.delete('/order/device', data: guidStrings);
      try {
        return ApiResponse.fromMap(response.data);
      } catch (ex) {
        throw Exception(ex);
  ...
  Future<ApiResponse> getOrder(String guid) async {
    Dio client = Client().init();
    try {
      final response = await client.get('/order/device/$guid');
      try {
        return ApiResponse.fromMap(response.data);
      } catch (ex) {
        throw Exception(ex);
  ...
  Future<ApiResponse> saveOrder(OrderSettingModel orderModel) async {
    Dio client = Client().init();
    final data = orderModel.toJson();
    try {
      final response = await client.post('/order/device', data: data);
      try {
        return ApiResponse.fromMap(response.data);
      } catch (ex) {
        throw Exception(ex);
  ...
  Future<ApiResponse> updateOrder(String guid, OrderSettingModel orderModel) async {
    Dio client = Client().init();
    final data = orderModel.toJson();
    // print(data);
    try {
      final response = await client.put('/order/device/$guid', data: data);
      try {
        return ApiResponse.fromMap(response.data);
      } catch (ex) {
        throw Exception(ex);
