...
class DimensionSearchScreenState extends State<DimensionSearchScreen> with SingleTickerProviderStateMixin {
  ...
  void loadDataList(String search) {
    context
        .read<ProductDimensionBloc>()
        .add(ProductDimensionLoadList(offset: (dimensiontListData.isEmpty) ? 0 : dimensiontListData.length, limit: global.loadDataPerPage, search: search));
  }
