...
class PosMediaSearchScreenState extends State<PosMediaSearchScreen> with SingleTickerProviderStateMixin {
                  ...
                  if (selectGuid != "") {
                    Navigator.pop(
                        ...
                        global.SearchGuidCodeNameModel(
                            guid: posMediaListData[currentListIndex].guidfixed,
                            code: posMediaListData[currentListIndex].code,
                            names: posMediaListData[currentListIndex].description,
                            isCancel: false));
                  }
                }
  ...
  Widget listObject(PosMediaModel value) {
    return GestureDetector(
        onTap: () {
          Navigator.pop(context, global.SearchGuidCodeNameModel(guid: value.guidfixed, code: value.code, names: value.description, isCancel: false));
        },
        child: Container(
            decoration: BoxDecoration(
