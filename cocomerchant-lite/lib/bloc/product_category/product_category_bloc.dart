...
import 'package:cocomerchant_lite/repositories/product_category_repository.dart';
...
class ProductCategoryBloc extends Bloc<ProductCategoryEvent, ProductCategoryState> {
  ...
  void onProductCategoryLoad(ProductCategoryLoadList event, Emitter<ProductCategoryState> emit) async {
    ...
    try {
      final results = await _productCategoryRepository.getCategoryList(offset: event.offset, limit: event.limit, search: event.search, groupNumber: event.groupNumber);
